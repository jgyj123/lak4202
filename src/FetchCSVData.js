...
export default function FetchCSVData(props) {
  ...
  const fetchCSVData = () => {
    const csvUrl =
      "https://docs.google.com/spreadsheets/d/e/2PACX-1vQaR8s8V36JzoOPT23A-Wl5VFtRlna_wXMgagG_siwJDDFyqa0piu_gwkB7VjPHWBMIy8GDH9y0yhIf/pub?output=csv"; // Replace with your Google Sheets CSV file URL
    ...
    axios
      ...
      .then((response) => {
        ...
        const chapters = fetchUniqueChapters(parsedCsvData);
        props.setChapters(chapters);
        props.setData(parsedCsvData);
